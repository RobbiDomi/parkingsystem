...
public class ParkingDataBaseIT {
    ...
    public void testParkingACar() {
        ...
        //DONE: check that a ticket is actually saved in DB and Parking table is updated with availability
...
//      assertTrue(tktGen.getPrice()>=0);
        assertTrue(tktFar);
        assertNotNull(tktGen.getOutTime());
    }
}
